...
Rxleaf  = 1.838      # maximum rate of leaf number accumulation
Rxleaf  = 0.4      # kale
Txleaf  = 34.7       # critical temperature for leaf number accumulation
Toleaf  = 20.57      # optimum temperature at Rxleaf
Toleaf  = 24.1      # kale
...
## 
    ...
    def calcTempdvs(self, Ta):
        ...
        # print(Ta, rate, self.sumTemp, tempdvs)
...
##############################################################################################################        
    ...
    def calcBD(self, Ta, dap):
        ...
        if dap < self.daysRoot:                                ###""" 2021 UW 추가 """
            ...
            # print(self.midRateLN(Ta))
        self.leafNumber += leafRate
        # print(self.leafNumber)
