...
#         ]
        ...
        out_test.to_csv('output/hour/check_hour.csv') # 파라미터 추출용
        out_growth_param.to_csv('output/hour/growth_param.csv') # 파라미터 추출용
        out_gasex_param.to_csv('output/hour/gasex_param.csv') # 파라미터 추출용
